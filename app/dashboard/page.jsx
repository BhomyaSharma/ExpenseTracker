  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white">
      ...
      <aside className="w-72 bg-gray-900 p-6 shadow-xl">
        <h2 className="text-3xl font-bold text-red-500 mb-8 tracking-wide">BudgetTrack</h2>
        <nav className="space-y-6">
          <Link href="/dashboard" className="block py-3 px-6 bg-red-600 rounded-lg text-lg font-semibold hover:scale-105 transition">
            Dashboard
          </Link>
          <Link href="/budget" className="block py-3 px-6 hover:bg-gray-700 rounded-lg text-lg font-semibold transition">
            Budget
          </Link>
          <Link href="/transactions" className="block py-3 px-6 hover:bg-gray-700 rounded-lg text-lg font-semibold transition">
            Transactions
          </Link>
          <Link href="/settings" className="block py-3 px-6 hover:bg-gray-700 rounded-lg text-lg font-semibold transition">
            Settings
          </Link>
        </nav>
      </aside>
